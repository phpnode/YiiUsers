<?php
/**
 * A partial view that allows an administrator to edit a user's preferences
...
?>
<h4 class="subheader">These settings affect how the site behaves for this user.</h4>
<?php
